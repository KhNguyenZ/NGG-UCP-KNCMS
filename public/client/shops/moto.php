...
?>
<title>Cửa Hàng Moto | <?= $knsite['Title'] ?></title>
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Cửa hàng moto</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <?php
                foreach ($KNCMS->get_list("SELECT * FROM `kncms_vehs` WHERE `amount` > 0 AND `type` = 'moto' ") as $data) { ?>
                    <div class="col-md-4">
                        <center>
